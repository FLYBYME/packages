...
export class IsomorphicCrypto {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    private static crypto: { subtle: SubtleCrypto, getRandomValues(array: Uint8Array): Uint8Array } | null = (typeof globalThis !== 'undefined' && globalThis.crypto)
        ? globalThis.crypto as unknown as { subtle: SubtleCrypto, getRandomValues(array: Uint8Array): Uint8Array }
        // eslint-disable-next-line @typescript-eslint/no-require-imports
        : (typeof require !== 'undefined' ? (require('node:crypto') as { webcrypto: { subtle: SubtleCrypto, getRandomValues(array: Uint8Array): Uint8Array } }).webcrypto : null);
    ...
    static async sha256(data: string | Uint8Array): Promise<string> {
        ...
        const hashBuffer = await this.crypto.subtle.digest('SHA-256', msgUint8 as BufferSource);
